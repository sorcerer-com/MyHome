    ...
    public static class OpenIdConnect
    {
        ...
        public static bool HandleAuth(HttpContext context, string oidcAddress, string clientId)
        {
            ...
            try
            {
                ...
                query["redirect_uri"] = $"{context.Request.Scheme}://{context.Request.Host}/api/oauth2/callback";
        ...
        public static bool HandleCallback(HttpContext context, string oidcAddress, string clientId, string clientSecret)
        {
            try
            {
                ...
                var parameters = new Dictionary<string, string>
                {
                    ...
                    { "code", code },
                    { "redirect_uri", $"{context.Request.Scheme}://{context.Request.Host}/api/oauth2/callback" },
                };
                ...
                logger.Debug($"OpenIdConnect login successful for user: {userInfo["sub"]} ({userInfo["name"]})");

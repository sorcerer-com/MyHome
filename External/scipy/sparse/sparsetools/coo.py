...
def coo_todense(*args):
  """
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        signed char const [] Ax, signed char [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        unsigned char const [] Ax, unsigned char [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        short const [] Ax, short [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        unsigned short const [] Ax, unsigned short [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        int const [] Ax, int [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        unsigned int const [] Ax, unsigned int [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        long long const [] Ax, long long [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        unsigned long long const [] Ax, unsigned long long [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        float const [] Ax, float [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        double const [] Ax, double [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        long double const [] Ax, long double [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        npy_cfloat_wrapper const [] Ax, npy_cfloat_wrapper [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        npy_cdouble_wrapper const [] Ax, npy_cdouble_wrapper [] Bx)
    coo_todense(int const n_row, int const n_col, int const nnz, int const [] Ai, int const [] Aj, 
        npy_clongdouble_wrapper const [] Ax, npy_clongdouble_wrapper [] Bx)
    """
